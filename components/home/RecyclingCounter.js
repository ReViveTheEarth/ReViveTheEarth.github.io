...
export default function RecyclingCounter({ targetValue = 2847563 }) {
  ...
  return (
    ...
    >
      {/* Glass container */}
      <div className="relative backdrop-blur-2xl rounded-3xl p-8 md:p-12 border border-white/10"
        style={{
      ...
      >
        ...
        <div className="flex items-center justify-center gap-1 md:gap-2">
          <span
            ...
            style={{
              background: 'linear-gradient(180deg, #34D399 0%, #06B6D4 50%, #3B82F6 100%)',
          ...
          {/* Unit */}
          <span className="text-2xl md:text-4xl lg:text-5xl font-light text-white/60 ml-2 md:ml-4">
            kg
          </span>
        </div>
